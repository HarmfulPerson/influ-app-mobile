...
import EachCampaign from "../../components/EachCampaign/EachCampaign";
import EachCooperation from "../../components/EachCooperation/EachCooperation";
  ...
  return (
    <SafeAreaView edges={["top"]} style={styles.container}>
      ...
      >
        ...
        <AddButtonList onButtonClick={() => router.push("/addCollaboration")} />
      </LinearGradient>
    </SafeAreaView>
  );
}
