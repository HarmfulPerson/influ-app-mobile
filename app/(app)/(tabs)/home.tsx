...
const Index = () => {
  ...
  const navigateToCooperations = () =>
    router.push({
      pathname: "/CooperationList",
    });
    ...
    >
      <View style={styles.userBarContainer}>
        ...
        <Button
          ...
          iconAlign="left"
          icon={
            <Bell width={16} height={16} color={Colors.grayscale.text.body} />
          }
          style={styles.notificationsButton}
        />
      </View>
      <View
        onPress={() => navigateToCooperations()}
      ...
      <View style={styles.advertisementTitleContainer}>
        <Text style={styles.advertisementTitle}>Najnowsze ogłoszenia</Text>
        <TouchableWithoutFeedback onPress={() => navigateToAdvertisement()}>
