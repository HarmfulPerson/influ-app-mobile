    ...
    <View flex={1} backgroundColor="#151419" alignItems="center">
      ...
      <View style={styles.contentWrapper}>
        <View style={styles.titlesContainer}>
          <Text style={styles.header}>Witaj w kreatorze ogłoszenia!</Text>
          <Text style={styles.subtitle}>
            Ten kreator przeprowadzi Cię przez proces tworzenia nowego
            ogloszenia do współpracy z influencerami.
          </Text>
        </View>
        <ImageBackground
        ...
        <View style={styles.buttonContainer}>
          <Button
            text="Zaczynamy!"
            onPress={() => router.push("addCollaboration/steps/pickCategories")}
            variant="primary"
            style={styles.navigatToNextPageButton}
          ></Button>
        </View>
      </View>
    </View>
