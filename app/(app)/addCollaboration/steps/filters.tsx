...
export default function Fiters() {
    ...
    const canProceed = () =>
        filter.sexes.length &&
        filter.ageRange.length &&
        filter.socialRanges.length;

    const handleNavigateToNextPage = () => {
        console.log(filter.socialRanges);
        router.push({
    ...
    const mainArea = (
        <View flex={1}>
            ...
            <Text style={styles.subtitle}>
                Określ demograficzne cechy grupy odbiorców, do których chcesz
                dotrzeć za pomocą swojej reklamy
            </Text>
