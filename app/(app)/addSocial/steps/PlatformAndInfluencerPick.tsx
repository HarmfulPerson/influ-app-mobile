...
import InfluencerPicker from "../common/InfluencerPicker";
...
const PlatformAndInfluencerPick = () => {
  ...
  const [platformAndInfluencer, setPlatformAndInfluencer] =
    useState<PlatformAndInfluencer>({ platforms: [], influencer: null });
  ...
  const canProceed = () =>
    ...
    Object.keys(platformAndInfluencer.influencer || {}).length;
  ...
  const handleNavigateNextPage = () => {
    router.push({
      ...
      params: {
        pickedCampaign,
        user: platformAndInfluencer.influencer?.uid,
  ...
  const handleClearInfluencer = () => {
    setPlatformAndInfluencer({ ...platformAndInfluencer, influencer: null });
  };
          ...
          triggerButton={
            ...
            >
              <Input
                ...
                style={{ flex: 1 }}
                value={platformAndInfluencer.influencer?.username}
