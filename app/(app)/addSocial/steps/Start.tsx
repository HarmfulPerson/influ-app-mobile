    ...
    <View flex={1} backgroundColor="#151419" alignItems="center">
      ...
      <View style={styles.contentWrapper}>
        <View style={styles.titlesContainer}>
          <Text style={styles.header}>Witaj w kreatorze współpracy!</Text>
          <Text style={styles.subtitle}>
            Ten kreator przeprowadzi Cię przez proces dodawania współpracy z
            influencerami.
          </Text>
        </View>
        ...
        <View style={styles.buttonContainer}>
          <Button
            text="Zaczynamy!"
            onPress={() => router.push("addSocial/steps/CompanyLink")}
            variant="primary"
