...
export default function Influencer() {
    const { data, error } = useAuthGetData(`/role`, { method: "GET" });
    ...
    useEffect(() => {
        if (data)
            setRegisterData({
                ...registerData,
                roles: filterInfluencerUid(data.data),
            });
    }, [data]);
    ...
    return (
        <View style={styles.container}>
            <TopBox
                ...
                headerText="Zakładasz konto jako influencer"
            />
                    ...
                    <Form.Trigger asChild>
                        <>
                            <ScrollView nestedScrollEnabled={true}>
                                ...
                                {registerData.typeOfReckoning ===
                                TYPE_OF_RECKONING.jdg ? (
                                    <JdgForm
