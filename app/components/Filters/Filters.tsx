      ...
      <>
        ...
        <View style={styles.sliderContainer}>
          <View style={styles.sliderLabelContainer}>
            ...
            <Text style={styles.ageRangeLabel}>{`${age[0]}-${age[1]}`}</Text>
          </View>
          <SimpleSlider
            value={age}
          ...
          <View style={styles.minMaxAgeLabelContainer}>
            <Text style={styles.minMaxLabel}>{`${ageRange.min} lat`}</Text>
            <Text style={styles.minMaxLabel}>{`${ageRange.max} lat`}</Text>
          </View>
          <View style={styles.reachContainer}>
            <Text style={styles.reachTitle}>Zasięg na social mediach</Text>
            {!!Object.keys(socialRanges).length && (
              <View style={styles.reachButtonsContainer}>
                <Button
                  text={socialRanges.micro.displayName}
                  onPress={() => handleSetRange(socialRanges.micro)}
                  style={styles.buttonMicro}
                  variant={
                    range.some(
                      (item: any) => item.name === socialRanges.micro.name
                    )
                      ? "primary"
                      : "secondary"
                  }
                ...
                <Button
                  ...
                  onPress={() => handleSetRange(socialRanges.small)}
                  style={styles.buttonSmall}
                  variant={
                    range.some(
                      (item: any) => item.name === socialRanges.small.name
                    )
                      ? "primary"
                      : "secondary"
                  }
                ...
                <Button
                  ...
                  onPress={() => handleSetRange(socialRanges.medium)}
                  style={styles.buttonMedium}
                  variant={
                    range.some(
                      (item: any) => item.name === socialRanges.medium.name
                    )
                      ? "primary"
                      : "secondary"
                  }
                ...
                <Button
                  ...
                  onPress={() => handleSetRange(socialRanges.big)}
                  variant={
                    range.some(
                      (item: any) => item.name === socialRanges.big.name
                    )
                      ? "primary"
                      : "secondary"
                  }
                ...
                <Button
                  ...
                  onPress={() => handleSetRange(socialRanges.large)}
                  style={styles.buttonLarge}
                  variant={
                    range.some(
                      (item: any) => item.name === socialRanges.large.name
                    )
                      ? "primary"
                      : "secondary"
                  }
