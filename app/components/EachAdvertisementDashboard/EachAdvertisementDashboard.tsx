...
export default function EachAdvertisementDashboard(item: { index: number; item: Advertisement }) {
    ...
    <View key={advertisement.uid} style={styles.wrapper}>
      <View style={styles.titleContainer}>
        ...
        <View style={styles.companyInfoContainer}>
          <Text style={styles.nameOfCompany}>{advertisement.createdByUser?.nameOfCompany}</Text>
      ...
      <View style={styles.platformAndPublicationContainer}>
        <View style={styles.platformsContainer}>
          <View>
            <Tv height={16} width={16} color={Colors.grayscale.surface.disabled} />
          </View>
        ...
        <View style={styles.calendarContainer}>
          <View style={styles.calendar}>
            <Calendar height={16} width={16} color={Colors.grayscale.surface.disabled} />
          </View>
          <View style={styles.publicationContainer}>
            <Text style={styles.publicationText}>Data publikacji</Text>
